...
class Calendar extends Base {
	...
	public function parse($language, IEvent $event, IEvent $previousEvent = null) {
		...
		if ($event->getSubject() === self::SUBJECT_ADD) {
			...
			// TODO: if the user doesn't have Calendar they will not find the trashbin. We could
			//       also lie here and also say it was deleted.
			$subject = $this->l->t('{actor} moved calendar {calendar} into the trashbin');
		} elseif ($event->getSubject() === self::SUBJECT_MOVE_TO_TRASH . '_self') {
			// TODO: if the user doesn't have Calendar they will not find the trashbin. We could
			//       also lie here and also say it was deleted.
			$subject = $this->l->t('You moved calendar {calendar} into the trashbin');
