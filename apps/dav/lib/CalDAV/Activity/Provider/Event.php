...
class Event extends Base {
	...
	public function parse($language, IEvent $event, IEvent $previousEvent = null) {
		...
		if ($event->getSubject() === self::SUBJECT_OBJECT_ADD . '_event') {
			...
			$subject = $this->l->t('{actor} moved event {event} of calendar {calendar} into the trashbin');
		} elseif ($event->getSubject() === self::SUBJECT_OBJECT_MOVE_TO_TRASH . '_event_self') {
			$subject = $this->l->t('You moved event {event} of calendar {calendar} into the trashbin');
